...
def update_3d_cube(val):
    ...
    # <Exercise 4.4 (3)>
    # TODO How to updeted draw_3d_cube

    tx = get_3d_rotation_matrix(np.radians(theta_x), 0)
    # draw_3d_cube(tx @ verticesCube)
    ty = get_3d_rotation_matrix(np.radians(theta_y), 1)

    tz = get_3d_rotation_matrix(np.radians(theta_z), 2)
    com = tx @ ty @ tz

    draw_3d_cube(com @ verticesCube)
...
verticesCube2 = np.array([[12, 12, 112, 112, 12, 12, 112, 112],
                         [12, 112, 112,  12,  12, 112, 112,  12],
                         [12,  12,  12,  12, 112, 112, 112, 112]])
